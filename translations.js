...
window.AC_TRANSLATIONS = {
  ...
  uk: {
    ...
    index: {
      ...
      navCards: [
        { icon:'🪞', title:'Ти коли-небудь міняв усе з нуля?',             desc:'Не план. Серія точок, після яких назад уже не можна.',                              href:'page.html?id=reset'     },
        { icon:'🧩', title:'Тобі казали, що ти занадто багато думаєш?',    desc:'Може, справа не в кількості думок — а в якості питань.',                             href:'page.html?id=overthink' },
        { icon:'🔬', title:'Ти знаєш, чому приймаєш свої рішення?',       desc:'Не ті, які пояснюєш іншим. Справжні.',                                               href:'page.html?id=decisions' },
        { icon:'📡', title:'Слова чи дії — чому ти довіряєш?',            desc:'Іноді краще дивитися, ніж слухати. Тут — без фільтрів.',                               href:'page.html?id=trust'     },
        { icon:'💬', title:'Є думка, якій нікуди подітися?',              desc:'Не шукай відповідь. Іноді потрібна просто людина, яка зрозуміє питання.',              href:'page.html?id=thought'   }
      ]
    },
    about: {
  ...
  no: {
    ...
    index: {
      ...
      quoteAuthor: '— Andrii Chepelovskyi',
      navCards: [
        { icon:'🪞', title:'Har du noen gang begynt helt på nytt?',        desc:'Ikke en plan. En serie punkter du ikke kan gå tilbake fra.',                          href:'page.html?id=reset'     },
        { icon:'🧩', title:'Har noen sagt at du tenker for mye?',          desc:'Kanskje problemet ikke er mengden tanker — men kvaliteten på spørsmålene.',            href:'page.html?id=overthink' },
        { icon:'🔬', title:'Vet du hvorfor du tar dine egne valg?',        desc:'Ikke de du forklarer til andre. De virkelige.',                                        href:'page.html?id=decisions' },
        { icon:'📡', title:'Ord eller handlinger — hva stoler du på?',     desc:'Noen ganger er det bedre å se enn å lytte. Her — uten filtre.',                        href:'page.html?id=trust'     },
        { icon:'💬', title:'Har du en tanke som ikke finner sin plass?',   desc:'Ikke let etter svar. Noen ganger trenger du bare en som forstår spørsmålet.',          href:'page.html?id=thought'   }
      ]
    },
    about: {
